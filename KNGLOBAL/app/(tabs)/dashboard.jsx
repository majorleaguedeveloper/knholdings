    ...
    try {
      ...
      if (user.role === 'admin') {
        const [membersRes, sharesStatsRes, allSharesRes] = await Promise.all([
          axios.get('http://192.168.108.159:5000/api/admin/members', config),
          axios.get('http://192.168.108.159:5000/api/shares/stats', config),
          axios.get('http://192.168.108.159:5000/api/admin/shares', config),
        ]);
